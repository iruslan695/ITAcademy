...
public final class CommandProvider {
    ...
    public CommandProvider() {
        ...
        commands.put(FrontCommand.GO_TO_TOP_UP_BALANCE_PAGE, new GoToTopUpBalancePageCommand());
        ...
        commands.put(FrontCommand.GO_TO_READ_JOURNAL_PAGE, new GoToReadJournalPageCommand());
        commands.put(FrontCommand.TOP_UP_BALANCE_PAGE, new TopUpBalancePageCommand());
    }
