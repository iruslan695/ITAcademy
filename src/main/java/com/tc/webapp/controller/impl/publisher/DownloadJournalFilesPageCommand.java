    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (result) {
                ...
                String uploadPath = ControllerConstant.UPLOAD_PATH + File.separator + pubName + File.separator + titleName + File.separator;
                ...
                for (Part part : request.getParts()) {
                    part.write(uploadPath + File.separator + releaseNumber + ControllerConstant.FILE_EXTENSION);
                }
